...
You generate a key pair (`cosign.key` / `cosign.pub`). Store the private key securely in Jenkins credentials. Distribute the public key to anyone who needs to verify.
